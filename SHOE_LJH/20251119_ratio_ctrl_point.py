...
# 전역 설정
# -----------------------
file_name = "20251120/CTRL40/outline_points_master_L_20251120.csv"
output_file = "20251120/CTRL40/pred_Data_RATIO_OUTLINE_230_280.csv"

# ★ 실행 시간 요약 저장 경로 (추가됨)
summary_output_file = "20251120/CTRL40/ratio_runtime_summary.csv"
...
def scale_master_csv_by_type_min(input_path, output_path, target_sizes):
    ...
    coord_cols = [col for col in df.columns if col.startswith(('x', 'y')) and col[1:].isdigit() and int(col[1:]) <= 40]
